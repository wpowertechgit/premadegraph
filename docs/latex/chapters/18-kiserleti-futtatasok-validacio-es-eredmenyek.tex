...
A dolgozat elkészítésekor a rendszer aktuális állapota nemcsak a dokumentáció, hanem közvetlen futtatás alapján is ellenőrizésre került. A főbb helyi ellenőrzések:
...
A dolgozat ezen a ponton már nem csak tervekről, hanem ténylegesen végrehajtható modulokról számol be.
...
A dolgozat nem egyszerűen egy algoritmus vagy egy látványos oldal bemutatása, hanem annak dokumentálása, hogy ezek a részek együtt már egy kutatásképes rendszerként viselkednek.
...
Védhető az a megközelítés, ha ez az ország-elemzési vonal \emph{kiegészítő, exploratív} modulnak tekinthető:
