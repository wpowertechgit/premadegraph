...
Kísérleti jellegű, de a pipeline szerves folytatásaként értelmezendő hozzájárulás a Tribal NeuroSim kiterjesztés, amelyben a gráfból levezetett klaszterprofilok ágens-alapú szimulációban vizsgálhatók. A kísérlet kerete exploratív: nem kísérel meg közvetlen előrejelzést valódi meccskimenetelekre, de reprodukálható, seed-alapú futtatásokban megmutatja, hogy a két adatkészlet strukturális különbségei eltérő szimulációs viselkedésben jelennek-e meg.
