...
A \ref{fig:neurosim-run-sq42-last2a}. és \ref{fig:neurosim-run-sq42-last2b}. ábra a tick=1987-es végső kétszereplős állapotot mutatja: Tribe 89 domináns területi helyzetben, Tribe 10 sarokba szorítva.
...
A \ref{fig:neurosim-run-sq42-last}. ábra a SoloQ seed=42 futtatás végállapotát mutatja, Tribe 89 (Vanguard/Risk) győzelmével, 6\,356 tile-os végső területtel.
...
A \ref{fig:neurosim-run-sq7777-firstempire}. ábra a SoloQ seed=7777 futtatás első Empire eseményét mutatja (tick=301).
...
A \ref{fig:neurosim-run-sq7777-tick500}. és \ref{fig:neurosim-run-sq7777-tick1000}. ábra a korai és a középső konszolidációs állapotot mutatja (tick=500 és tick=1000).
...
A \ref{fig:neurosim-run-sq7777-totalwar}. ábra a tick=2100-as Totális Háború utáni állapotot mutatja 18 túlélővel.
...
A \ref{fig:neurosim-run-sq7777-last2a}. és \ref{fig:neurosim-run-sq7777-last2b}. ábra a végső kétszereplős állapotot mutatja (tick=2510): Tribe 45 Vanguard/Expansion és Tribe 70 Supply/Resource profilokkal.
...
A \ref{fig:neurosim-run-sq7777-last}. ábra a SoloQ seed=7777 futtatás végállapotát mutatja, Tribe 70 (Supply/Resource) győzelmével.
