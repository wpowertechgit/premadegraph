...
\bibitem{opgg-features}
OP.GG, ``Guide to Features,'' OP.GG Help Center. [Online]. Available:
\url{https://help.op.gg/hc/en-us/sections/48325746929689-Guide-to-Features}
[Hozzáférés: 2026. júl. 1.]
...
Hagberg, A., Schult, D., and Swart, P., ``NetworkX: greedy\_modularity\_communities,''
...
\bibitem{premadegraph-full}
T. Krisztián-Erik, \textit{Premade Graph Explorer -- kibővített verzió}, BSc dolgozat,
Universitatea de Medicină, Farmacie, Științe și Tehnologie ``George Emil Palade,''
Târgu-Mureș, 2026. [Online]. Available:
\url{https://github.com/wpowertechgit/premadegraph/blob/main/docs/latex/main.pdf}
