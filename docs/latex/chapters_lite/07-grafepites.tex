...
Az elsődleges gráfállapotot a Rust réteg állítja elő. A Python oldal megőrzi az adatgyűjtés, gyors prototipizálás és kompatibilitási gráfgenerálás szerepét. A \textit{flexset} és \textit{soloq} összehasonlítás, az asszortativitás és a gráfvizualizáció Rust-alapú gráfmodellre támaszkodik.
...
Az alábbi táblázat ugyanazt a játékospárt mutatja be, kétféle keresési módban:
