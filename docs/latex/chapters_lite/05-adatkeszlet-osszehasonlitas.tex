...
Az elemzés két eltérő queue-típusból gyűjtött adatkészletre épül: a Flex Queue és a Solo/Duo Queue eltérő matchmaking-mechanikája eleve különböző gráfstruktúrát eredményez. Ha ugyanazt a pipeline-t mindkét dataseten lefuttatjuk, a kapott eltérés közvetlenül a queue-mechanikából vezethető le -- nem modellparaméter-különbségből.
