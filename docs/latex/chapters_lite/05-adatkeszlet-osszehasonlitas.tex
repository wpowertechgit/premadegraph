...
A Flex Queue (440-es queue ID) csapatszedést tesz lehetővé: játékosok 2--5 főig premade csapatot alkothatnak. Ez azt jelenti, hogy a szövetségesi pozícióban ismételten megjelenő játékospárok egy része \emph{szándékolt ismétlődés}. Az ally/enemy arány (73.17\% ally a \textit{flexset}-en) részben ennek a természetes mechanizmusnak a következménye, hiszen mindkét esetben a premade kapcsolatok begyűjtése volt a cél.

A Solo/Duo Queue (420-as queue ID) legfeljebb két fős premade-et engedélyez. Az ally/enemy arány (65.24\% ally a \textit{soloq}-on) alacsonyabb, ami összhangban van azzal, hogy a véletlenszerűbb meccsek kevesebb domináns szövetségesi kapcsolatot hoznak létre. Jelen lehet egyes klaszterekben akár egy harmadik vagy egy negyedik játékos is, mivel a seedelt játékos nem feltétlenül egy játékossal játszik, egy climb során.
