...
A törzsek öt polity-szinten fejlődhetnek: \textit{Wandering Band}, \textit{Settled Village}, \textit{Chiefdom}, \textit{Kingdom} és \textit{Empire}. Minden szintlépéshez populáció-, terület- és szövetségesi küszöbértékek teljesítése szükséges; magasabb szinten több maximális populáció és jobb harci hatékonyság érhető el, de nagyobb élelmiszer-fenntartási igény is keletkezik. Az Empire szint elérése a győzelmi feltétel: mind a négy teljes futtatás, mind a 103-seed sweep minden futtatása Empire-szintű győztessel zárult.

A harci kimenet Poisson-folyamaton alapul: a szembenálló felek populációmérete és harci artifactja befolyásolja a várható veszteséget, de a konkrét tick-szintű kimenet véletlenszerű. A \textit{liveness-fix} a determinizmus-hiba javítása volt: a klaszterek rendezetlen iterációja különböző tick-sorrenden át különböző kimenethez vezetett; a \textit{sort\_by(id)} bevezetése után az újrafuttatások bit-azonos eredményt adnak. A részletes fejlődési feltételek és az iteratív tervezési döntések a kibővített verzióban találhatók \cite{premadegraph-full}.
...
Azonos szabálykörnyezetben a \textit{flexset}-priorok mindkét seed mellett Warband/Combat győztest adtak (agresszió 0{,}13--0{,}18), míg a \textit{soloq}-priorok seedenként eltérő archetípust (Vanguard, illetve Supply) -- a kezdeti klaszter-prior tehát mérhetően megváltoztatja a kimenetet. Az eredmények nem bizonyítanak valódi játékos-pszichológiát és nem adnak előrejelzést tényleges League of Legends meccsek kimenetelére.
