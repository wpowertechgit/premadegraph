...
\textbf{#1}\par
\vspace{0.5em}
Az SVG forrásfájl megtalálható a dokumentációs eszköztárban.\par
\vspace{0.35em}
\textit{#2}
}
}
...
\diagramplaceholder{Tevékenységdiagram a korai adatgyűjtő és gráfépítő pipeline-hoz}{Forrásfájl: activity diagram.svg}
...
\diagramplaceholder{Komponensdiagram a jelenlegi rendszerhez}{Forrásfájl: component diagram.svg}
...
\diagramplaceholder{Adatáramlási diagram a gyűjtéstől a frontendig}{Forrásfájl: dataflow diagram.svg}
...
\diagramplaceholder{Relációs modell a klaszter- és játékosperzisztenciához}{Forrásfájl: relational model diagram.svg}
...
\diagramplaceholder{Osztály- és tárolási nézet a gráf- és klaszterobjektumokhoz}{Forrásfájl: class diagram.svg}
...
\diagramplaceholder{Szekvenciadiagram a frontend--backend--Rust kérésekhez}{Forrásfájl: sequence diagram.svg}
...
A repository dokumentációs csomagja több SVG-alapú rendszerábrát is tartalmaz (\texttt{activity diagram.svg}, \texttt{system statemachine research pipeline.svg}, \texttt{uml simplified vector\_2.svg}). Ezekből nem mindegyik került végleges, beégetett képként a dolgozat törzsébe, de fejlesztés közben fontos szerepük volt abban, hogy a rendszer ne essen szét egymásra rakódó feature-ök halmazára.

\diagramplaceholder{Állapotgép a kutatási pipeline fő lépéseihez}{Forrásfájl: system statemachine research pipeline.svg}
