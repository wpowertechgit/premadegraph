...
- `docs/tribal-neurosim-v3-desktop-contract-v1.md`
...
- Modify: `docs/tribal-neurosim-v3-desktop-contract-v1.md`
...
Proceed to a Civ-like terrain composition pass aligned with `docs/neurosim-tribal-simulation-critical-redesign.md`: biome clustering, river/coast readability, mountains/forests as actual map features, smoother territory borders, and less debug overlay noise. Then finish Node/Rust desktop control forwarding.
