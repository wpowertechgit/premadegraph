...
These notes support the systems architecture chapters: why the project moved toward explicit datasets, durable graph artifacts, Rust-backed analytics, and reproducible pathfinding experiments.
