...
- **Integration:** [premadegraph-x-genetic-neurosim-integration-plan.md](../../neurosim/chapter-writing/premadegraph-x-genetic-neurosim-integration-plan.md)
- **Theory:** [thesis-framework-signed-balance-assortativity.md](../graph-analytics/thesis-framework-signed-balance-and-assortativity.md)
