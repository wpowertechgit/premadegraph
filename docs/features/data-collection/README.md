...
Dataset collection is the proof layer. Flex Queue supports associative graph interpretation, while SoloQ acts as an individual-performance control group. Keep conclusions separate between these datasets.
