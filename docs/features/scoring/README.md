...
`opscore` is the main performance metric. `feedscore` is useful as a narrower supporting variable, especially for assortativity, but should not be presented as equal in scope to `opscore`.
