...
function buildMockBirdseyeData(): {
...
export default function GraphSpherePage() {
  ...
  }, [datasetMode, mockBirdseyeData, t.graphSphere.loadFailed]);
        ...
        <div style={{ display: "grid", justifyItems: "start", gap: "0.55rem" }}>
          ...
          {introOpen ? (
            ...
            >
              ...
              <div style={{ color: datasetMode === "mock" ? "#8ed0ff" : "#94a4b8", lineHeight: 1.45, fontSize: "0.84rem" }}>
                {datasetMode === "mock" ? t.graphSphere.mockDatasetActiveEffect : t.graphSphere.datasetModeEffect}
              </div>
            </div>
          ) : null}
        </div>
        ...
        {panelOpen ? (
          ...
          >
            <section style={{ display: "grid", gap: "0.55rem" }}>
              ...
              <div style={{ fontWeight: 700, marginTop: "0.15rem" }}>{t.graphSphere.datasetMode}</div>
              <div style={{ color: "#94a4b8", lineHeight: 1.45 }}>{t.graphSphere.datasetModeHelp}</div>
              <div style={{ display: "flex", gap: "0.55rem", flexWrap: "wrap" }}>
                <button
                  type="button"
                  onClick={() => setDatasetMode("full")}
                  style={{
                    ...buttonStyle(datasetMode === "full" ? "primary" : "ghost"),
                    padding: "0.72rem 0.92rem",
                  }}
                >
                  {t.graphSphere.fullDataset}
                </button>
                <button
                  type="button"
                  onClick={() => setDatasetMode("mock")}
                  style={{
                    ...buttonStyle(datasetMode === "mock" ? "primary" : "ghost"),
                    padding: "0.72rem 0.92rem",
                  }}
                >
                  {t.graphSphere.mockDataset}
                </button>
              </div>
              <div style={{ color: datasetMode === "mock" ? "#8ed0ff" : "#94a4b8", lineHeight: 1.45 }}>
                {datasetMode === "mock" ? t.graphSphere.mockModeBadge : t.graphSphere.datasetModeEffect}
              </div>
            ...
            <section style={{ display: "grid", gap: "0.45rem" }}>
              ...
              <div>{datasetMode === "mock" ? `${t.graphSphere.renderer} / mock` : t.graphSphere.renderer}</div>
