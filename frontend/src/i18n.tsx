  ...
  en: {
    app: {
      ...
      nav: {
        ...
        hungarian: "Hungarian",
        english: "English",
        brandSubtitle: "Match analysis, player graphs, route search, and network metrics.",
        navigateSection: "Navigate",
        actionsSection: "Actions",
        expandNavigation: "Expand navigation",
        collapseNavigation: "Collapse navigation",
        graphPipelineTitle: "Graph Pipeline",
        graphPipelineCaption: "Rebuild the association graph from the current dataset.",
        playerHygieneTitle: "Player Hygiene",
        playerHygieneCaption: "Normalize player records for cleaner graph views and summaries.",
        interfaceLanguageTitle: "Interface Language",
        interfaceLanguageCaption: "",
      },
      alerts: {
        errorPrefix: "Error",
        unknown: "Unknown",
    ...
    pathfinder: {
      ...
      pageDescription: "Choose two players and compare how different search strategies move through the same network.",
      availablePlayers: "Available Players",
      relationships: "Relationships",
      renderer: "Renderer",
      canvasOverlay: "Canvas overlay",
      whatGraphShows: "What the graph shows",
      whatGraphShowsText: "Each node is a player. Ally edges come from repeated cooperative play, and enemy edges come from repeated opposition.",
      ...
      algorithmsPlaybackText: "BFS expands evenly, Bidirectional meets in the middle, and Dijkstra or A* can prefer stronger repeated ties in weighted mode.",
      ...
      replayLibraryDescription: "Browse saved pathfinder runs and load any of them back into the canvas and playback controls.",
    ...
    graphSphere: {
      ...
      pageDescription: "Explore the full named-player network as a static star map.",
      datasetMode: "Dataset mode",
      datasetModeHelp: "Switch between the full exported graph and the built-in mock dataset.",
      datasetModeEffect: "Mock mode loads the smaller sample graph, while full mode loads the exported player graph.",
      fullDataset: "Full dataset",
      mockDataset: "Mock dataset",
      mockDatasetActiveEffect: "Mock mode is active, so this sphere is rendered from the smaller built-in graph.",
      mockModeBadge: "Mock sphere mode is active.",
    ...
    signedBalance: {
      ...
      pageDescription: "Test whether repeated ally and enemy relationships form more balanced or unbalanced signed triads.",
      controls: "Experiment controls",
      datasetMode: "Dataset mode",
      datasetModeHelp: "Switch between the full player graph and the smaller mock dataset.",
      datasetModeEffect: "Mock mode is easier to inspect, while full mode shows the full player graph.",
      fullDataset: "Full dataset",
      mockDataset: "Mock dataset",
      mockDatasetActiveEffect: "Mock mode is active, so the experiment runs on the smaller graph.",
      mockModeBadge: "Mock dataset mode is active.",
      ...
      researchReadingText: "A short read of the current result.",
      ...
      documentationIntro: "What is being measured and how to read it.",
      ...
      documentationImplementationNote: "With the same settings, this analysis should return the same result.",
    },
  },
  hu: {
    app: {
      ...
      nav: {
        ...
        hungarian: "Magyar",
        english: "Angol",
        brandSubtitle: "Meccselemzés, játékosgráfok, útvonalkeresés és hálózati mutatók.",
        ...
        graphPipelineCaption: "Az asszociációs gráf újraépítése az aktuális adathalmazból.",
        playerHygieneTitle: "Játékos karbantartás",
        playerHygieneCaption: "A játékosrekordok normalizálása tisztább gráfnézetekhez és összegzésekhez.",
    ...
    graphSphere: {
      ...
      pageDescription: "A teljes névvel rendelkező játékoshálózat itt statikus csillagtérként böngészhető.",
      datasetMode: "Adathalmaz mód",
      datasetModeHelp: "Váltás a teljes exportált gráf és a beépített mock adathalmaz között.",
      datasetModeEffect: "A mock mód a kisebb minta gráfot tölti be, a teljes mód az exportált játékosgráfot.",
      fullDataset: "Teljes adathalmaz",
      mockDataset: "Mock adathalmaz",
      mockDatasetActiveEffect: "A mock mód aktív, ezért ez a gömb a kisebb beépített gráfból renderelődik.",
      mockModeBadge: "A mock gömb mód aktív.",
    ...
    signedBalance: {
      ...
      pageDescription: "Ez az oldal azt méri, hogy az ismétlődő ally és enemy kapcsolatok inkább kiegyensúlyozott vagy kiegyensúlyozatlan előjeles triádokat alkotnak-e.",
      controls: "Kísérleti vezérlők",
      datasetMode: "Adathalmaz mód",
      datasetModeHelp: "Váltás a teljes játékosgráf és a kisebb mock adathalmaz között.",
      datasetModeEffect: "A mock mód könnyebben átlátható, a teljes mód a teljes játékosgráfot mutatja.",
      fullDataset: "Teljes adathalmaz",
      mockDataset: "Mock adathalmaz",
      mockDatasetActiveEffect: "A mock mód aktív, ezért a kísérlet a kisebb gráfon fut.",
      mockModeBadge: "A mock adathalmaz mód aktív.",
      ...
      researchReadingText: "Rövid értelmezés az aktuális futásról.",
      ...
      documentationIntro: "Mit mér ez az oldal, és hogyan olvasd az eredményt.",
      ...
      documentationImplementationNote: "Ugyanazokkal a beállításokkal ugyanazt az eredményt kell kapnod.",
    },
  },
};
