...
**Thesis Relevance:** Core dataset for Flex Queue associative graph analysis, dataset comparison, assortativity, and centrality studies. Signed balance is retained only as a methodological boundary case; see `../graph-analytics/signed-balance-methodological-retirement.md`.
